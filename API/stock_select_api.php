...
$sql_ = $conn -> prepare("SELECT company_name,stock_symbol,short_profit,long_profit FROM stock_group_info where stock_symbol LIKE '%$select_text%' or company_name LIKE '%$select_text%'");
$sql_ -> execute();
